...
import com.leafup.leafupbackend.global.oauth.api.dto.response.KakaoTokenResponse;
...
public class KaKaoAuthService implements AuthService {
    ...
    public String getAuthUrl() {
        return "https://kauth.kakao.com/oauth/authorize?" +
                "response_type=code" +
                "&client_id=" + oauthProperties.getKakao().clientId() +
                "&redirect_uri=" + oauthProperties.getKakao().redirectUri();
    }
